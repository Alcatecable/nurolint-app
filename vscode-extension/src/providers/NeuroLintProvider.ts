...
export class NeuroLintProvider implements vscode.Disposable {
  ...
  public async analyzeDocument(
    ...
    try {
      ...
      // All layers are free - no premium restrictions
  ...
  public async analyzeWorkspace(): Promise<AnalysisResult | null> {
    try {
      ...
      // Workspace analysis is free for all users
  ...
  /**
   * Get user tier - all features are free and open source
   * All 7 layers, all features available to everyone
   */
